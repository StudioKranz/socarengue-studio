...
export const metadata: Metadata = {
  title: "Issue One Preview | Socarengue Studio",
  description: "A public preview reading sequence for Socarengue Issue One.",
};
      ...
      <section className="archive-shell pt-8">
        <div className="mb-8 flex flex-col gap-5 border-b border-paper/12 pb-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-3 font-display text-5xl leading-tight text-paper md:text-7xl">Issue One</h1>
          </div>
          <Link
            href="/archive"
